...
WORKDIR /app
COPY --from=build_base /go/src/github.com/yz4898/speedtest-go/speedtest .
COPY --from=build_base /go/src/github.com/yz4898/speedtest-go/assets ./assets
COPY --from=build_base /go/src/github.com/yz4898/speedtest-go/settings.toml .
